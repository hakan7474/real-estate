...
public static class CollectionExtensions
{
    ...
    public static bool AddIfNotContains<T>([Diagnostics.CodeAnalysis.NotNull] this ICollection<T> source, T item)
    {
    ...
    public static IEnumerable<T> AddIfNotContains<T>([Diagnostics.CodeAnalysis.NotNull] this ICollection<T> source, IEnumerable<T> items)
    {
        Check.NotNull(source, nameof(source));
    ...
    /// <typeparam name="T">Type of the items in the collection</typeparam>
    /// <returns>Returns True if added, returns False if not.</returns>
    public static bool AddIfNotContains<T>([Diagnostics.CodeAnalysis.NotNull] this ICollection<T> source, [Diagnostics.CodeAnalysis.NotNull] Func<T, bool> predicate, [Diagnostics.CodeAnalysis.NotNull] Func<T> itemFactory)
    {
        Check.NotNull(source, nameof(source));
    ...
    public static IList<T> RemoveAll<T>([Diagnostics.CodeAnalysis.NotNull] this ICollection<T> source, Func<T, bool> predicate)
    {
    ...
    public static void RemoveAll<T>([Diagnostics.CodeAnalysis.NotNull] this ICollection<T> source, IEnumerable<T> items)
    {
        foreach (var item in items)
        {
            source.Remove(item);
